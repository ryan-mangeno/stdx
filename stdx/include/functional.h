...
class function<R(Args...), B> {
    public:
        ...
        function(F&& f) {
            ...
            static constexpr const vtbl_t vt = {
                [](void* func_buffer, Args&&... args) -> R {
                    return (*reinterpret_cast<StoredType*>(func_buffer))(::stdx::forward<Args>(args)...);
                },
                [](void* func_buffer) {
                    // Pointers have trivial destructors, Lambdas have real ones.
                    // StoredType handles both safely.
                    reinterpret_cast<StoredType*>(func_buffer)->~StoredType();
                },
                [](void* dest, void* src) {
    ...
    private:
        struct vtbl_t {
            R (*invoke)(void* func_buffer, Args&&...);
            void (*destroy)(void* func_buffer);
